...
<p align="center">
    ...
    />
    <img 
        src="https://img.shields.io/badge/Vite-5.x-646CFF?style=for-the-badge&logo=vite&logoColor=white" 
    />
    <img 
...
> **LiveEvents-Ticket** é uma plataforma web completa para venda de ingressos de eventos ao vivo — shows, festivais, teatro e esportes. Permite a criação de eventos, gestão de ingressos por setor, compra com checkout integrado e painel administrativo com relatórios de vendas.

---

## 📋 Sobre o Projeto

O **LiveEvents-Ticket** foi desenvolvido para oferecer uma experiência moderna de compra de ingressos online, inspirada em plataformas como Eventim e Ticketmaster. A aplicação oferece funcionalidades tanto para **usuários** (busca, compra, favoritos) quanto para **administradores** (criação de eventos, gestão de ingressos, relatórios).
...
- **Frontend:** React 18 + Vite, SPA com roteamento client-side e tema claro/escuro
- **Backend:** API REST com ASP.NET Core 8, Entity Framework Core, arquitetura modular
- **Banco de Dados:** SQL Server com Integrated Security
...
│   │   └── 📂 modules
│   │       ├── 📂 evento                # CRUD de eventos (model, dto, repository, service, rest)
...
Verifique o arquivo `appsettings.json` e ajuste a connection string se necessário:
...
| 💳 **Pagamentos** | Processamento de pagamentos integrado |
